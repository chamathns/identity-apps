...
export const SDKMeta = {
    angular: {
        ...
        samples: {
            basicUsage: {
                artifact:
                    "https://github.com/asgardeo/asgardeo-auth-angular-sdk/releases/download/v0.2.1/" +
    ...
    javascript: {
        ...
        samples: {
            javascript: {
                artifact:
                    "https://github.com/asgardeo/asgardeo-auth-spa-sdk/releases/download/v0.2.0/" +
    ...
    react: {
        ...
        samples: {
            basicUsage: {
                artifact:
                    "https://github.com/asgardeo/asgardeo-auth-react-sdk/releases/download/v0.2.0/" +

...
import { CodeEditor, GenericIcon, Heading, Text, MessageInfo } from "@wso2is/react-components";
...
export const TryoutSamples: FunctionComponent<TryoutSamplesPropsInterface> = (
    ...
    const handleAddCallback = (urls: string[], origin: string) => {
        ...
        const body: OIDCDataInterface = {
            ...
            allowedOrigins: shouldUpdateAllowedOrigins
                ? [ ...inboundProtocolConfig.oidc.allowedOrigins, origin ]
            ...
            return (
                <>
                    ...
                    <Button
                        ...
                        onClick={ () => window.open(SDKMeta.tomcatOIDCAgent.sample.artifact, "") }
                    >
                        <GenericIcon
                            transparent
                            icon={ JavaLogo }
                    ...
                    <Button
                        ...
                        onClick={ () => window.open(SDKMeta.tomcatOIDCAgent.sample.repository, "") }
                    >
            ...
            return (
                <>
                    ...
                    <Button
                        ...
                        className="sample-action-button download"
                        onClick={ () => window.open(SDKMeta.dotNet.sample.artifact, "") }
                    >
                        <GenericIcon
                            transparent
                    ...
                    <Button
                        basic
                        className="sample-action-button github"
                        onClick={ () => window.open(SDKMeta.dotNet.sample.repository, "") }
                    >
                        View source on GitHub
                        <Icon name="github" className="ml-2" />
                    </Button>

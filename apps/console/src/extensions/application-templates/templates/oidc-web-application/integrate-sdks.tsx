...
import { CodeEditor, Heading, Text, GenericIcon, Hint, MessageInfo } from "@wso2is/react-components";
    ...
    const handleAddCallback = (url: string) => {
        ...
        const body: OIDCDataInterface = {
            ...
            allowedOrigins: shouldUpdateAllowedOrigins
                ? [ ...inboundProtocolConfig.oidc.allowedOrigins, allowedOriginForCallbackUrl ]
                ...
                return (
                    <>
                        <p>
                            ...
                            /> <strong>Apache Maven</strong> (3.6.x or higher) as the package manager
                            and <GenericIcon
                            transparent
                            icon={ TomcatLogo }
                            size="micro"
                        ...
                        <Text className={ 'message-info-text' }>To download the latest <strong>Apache Maven</strong>, navigate to the official <a

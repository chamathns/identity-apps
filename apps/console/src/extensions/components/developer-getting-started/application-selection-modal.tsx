...
import { ContentLoader, Heading, LinkButton, ListLayout } from "@wso2is/react-components";
 ...
 */
interface ApplicationSelectionModalInterface extends ModalProps, TestableComponentInterface {
}

...
import { AppConstants, getEmptyPlaceholderIllustrations, history, updateResources } from "../../../../../features/core";
                                    ...
                                    >
                                        {
                                            roleList?.map((role, index) => {
                                                ...
                                                if (roleName?.length >= 1  && !roleName.includes("everyone")
    ...
    return (
        <>
            ...
            <Heading subHeading ellipsis as="h6">
                ...
                } }>roles</a> this user is assigned with and note that this
                will affect performing certain tasks. */}
                Add or remove the roles this user is assigned with and note that this
                will affect performing certain tasks.
            </Heading>
            <Divider hidden/>
            <Grid>
                                            ...
                                            <Table.Body>
                                                {
                                                    assignedRoles?.map((group) => {
                                                        ...
                                                        if (userRole?.length >= 1 && group?.value
                                                            && !userRole.includes("everyone") && !userRole.includes("system")) {
                                                            return (
                                                                <Table.Row>
                                                                    { showDomain && (

...
import { DropdownProps, Header, ListItemProps, PaginationProps, SemanticICONS } from "semantic-ui-react";
import {
...
export const AllUsersList: React.FunctionComponent<AllUsersListProps> = (props: AllUsersListProps): ReactElement => {
    ...
    const handleUserFilter = (query: string): void => {
        ...
        getAllUsersList(listItemLimit, listOffset, query, null, null);
    };

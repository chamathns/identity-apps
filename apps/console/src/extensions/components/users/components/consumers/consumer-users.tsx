...
import { DropdownProps, PaginationProps, Grid } from "semantic-ui-react";
...
const ConsumerUsersPage: FunctionComponent<ConsumerUsersPageInterface> = (
    ...
    const consumerAccountURL: string = useSelector((state: AppState) => state.config.deployment.accountApp.tenantQualifiedPath);
    /**
     * Set users list.
     */
    useEffect(() => {
            ...
            return (
                <>
                    <Text className="message-info-text">
                        <p> { t("extensions:manage.users.descriptions.consumerUser") }
                            <strong>
                                <a
    ...
    /**
     * Show the message about the consumer user portal.
     */
    const renderConsumerPortalInformation = (): ReactElement => {   
            ...
            return (
                <Grid verticalAlign="middle">
                    <Grid.Column floated="left" width={ 9 }>
                        <Text className="message-info-text">
                            <p>  { t("extensions:manage.users.descriptions.consumerAppInfo") } </p>
                        </Text>
                    </Grid.Column>
                    <Grid.Column floated="right" width={ 6 }>
                        <CopyInputField
                            ...
                            data-testid={ `${ testId }-consumer-account-readonly-input` }
                        />
                    </Grid.Column>
                </Grid>
            );
        ...
        return (
            <div className={ `mt-3 ${showInfo ? "mb-3" : "mb-6"}` }>
                {
                    <Message
                        content={ generateContent() }
                    />
    ...
    return (
        <>
            { renderConsumerPortalInformation() }

        ...
        >
            <Card.Group centered className="mt-5 mb-5">
                <Card
                    ...
                    className={
                        `user-selection-card ${
                            userTypeSelection === UserAccountTypes.CUSTOMER
                    ...
                    inline
                    id="Customer"
                    selected={ userTypeSelection === UserAccountTypes.CUSTOMER }
                ...
                <Card
                    ...
                    className={
                        `user-selection-card ${
                            userTypeSelection === UserAccountTypes.COLLABORATOR
                                ? "selected underlined-selection"
                                : ""
                        }`
                    }
                    ...
                    centered
                    id="Collaborator"
                    selected={ userTypeSelection === UserAccountTypes.COLLABORATOR }
                    inline
                    onClick={ handleUserTypeSelection }
                >
                    <Card.Content className="card-image-container">

...
import { CONSUMER_USERSTORE, USERSTORE_REGEX_PROPERTIES } from "../../../../../features/userstores";
                                ...
                                validation={ async (value: string, validation: Validation) => {
                                    ...
                                    if(!SharedUserStoreUtils.validateInputAgainstRegEx(value, passwordRegex)){
                                        ...
                                        validation.errorMessages.push( "Your password must contain a minimum of 8 " +
                                            ...
                                            "letter, one number, and one special character from !, @, #, $, %, *, &" );
                                    }
                                ...
                                <Field
                                    ...
                                    validation={ async (value: string, validation: Validation) => {
                                        ...
                                        await validateUserNamePattern().then(regex => {
                                            if (value && (!SharedUserStoreUtils.validateInputAgainstRegEx(value, regex)) ||
                                        ...
                                        try {
                                            ...
                                            // Some characters disallowed by username regex cause failure in below request.
                                            // Therefore, existence of duplicates is checked only post regex validation success.
                            ...
                            <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 10 }>
                                <Field
                                    ...
                                    validation={ async (value: string, validation: Validation) => {
                                        if (value.includes("/")) {
                                            validation.isValid = false;
                                            validation.errorMessages.push( "First Name cannot contain the forward slash (/)  "+
                                                "character." );
                                        }
                                    } }
                                />
                            ...
                            <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 10 }>
                                <Field
                                    ...
                                    validation={ async (value: string, validation: Validation) => {
                                        if (value.includes("/")) {
                                            validation.isValid = false;
                                            validation.errorMessages.push( "Last Name cannot contain the forward slash (/)  "+
                                                "character." );
                                        }
                                    } }
                                />

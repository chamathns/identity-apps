...
import { deleteAClaim, updateAClaim } from "../../../../../../features/claims/api";
                ...
                <Forms
                    onSubmit={ (values) => {
                        const data: Claim = {
                            ...
                            displayOrder: claim.displayOrder > 0 ? claim.displayOrder : DEFAULT_ATTRIBUTE_DISPLAY_ORDER,
                    ...
                    <Grid>
                        <Grid.Row columns={ 1 }>
                            <Grid.Column tablet={ 16 } computer={ 12 } largeScreen={ 9 } widescreen={ 6 } mobile={ 16 }>
                                ...
                                />
                                <Hint>
                                    The display name of the attribute in the user profile.
                                </Hint>
                                <Divider hidden />
                                <Field
                                    type="textarea"
                                ...
                                />
                                <Hint>A meaningful description for the attribute.</Hint>
                                <Divider hidden />
                                <Field
                                    type="text"
                                ...
                                />
                                <Hint>Use a regex pattern to validate the attribute input value.</Hint>
                                <Divider hidden />
                                <Field
                                    type="checkbox"

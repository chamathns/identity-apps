...
type PreLoaderPageInterface = TestableComponentInterface;

export const PreLoader: FunctionComponent<PreLoaderPageInterface> = (
    props: PreLoaderPageInterface
): ReactElement => {
    ...
    return (
        <div className={ "pre-loader-wrapper" } data-testid={ `${ testId }-wrapper` }>
            <div className="pre-loader" data-testid={ testId }>
                <svg data-testid={ `${ testId }-svg` } xmlns="http://www.w3.org/2000/svg" width="67.56" height="58.476"
                    ...
                    <g id="logo-only" transform="translate(-424.967 -306)">
                        ...
                        <path id="_1" data-name="1"
                              ...
                              transform="translate(-271.019 -65.725)" fill="#fff"/>
                    </g>
                </svg>
            </div>
        </div>

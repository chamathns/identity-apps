...
import { CertificateFormFieldModal } from "../../../../features/applications/components/modals";
import { AppState, ConfigReducerStateInterface } from "../../../../features/core";
import SinglePageApplicationTemplate
    from "../../../../features/applications/data/application-templates/templates/single-page-application/single-page-application.json";
        ...
        switch (value) {
            case ApplicationManagementConstants.IMPLICIT_GRANT:
                return t("console:develop.features.applications.forms.inboundOIDC.fields.grant.children." +
                    "implicit.hint") + " " + "Asgardeo SDKs adhere to security best practices, and does not " +
            ...
            <Grid.Row columns={ 1 }>
                <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 16 }>
                    ...
                    <Hint>
                        ...
                        >
                            Select type <Code withBackground>SSO-session</Code> to allow Asgardeo to bind the
                            ...
                            <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 16 }>
                                ...
                                <Hint>
                                    ...
                                    >
                                        ...
                                        token using the public key of your application. To use encryption, configure
                                        the JWKS endpoint or the certificate of your application in the Certificate
                                        section below.
                                    </Trans>
                                </Hint>
                            </Grid.Column>
                        ...
                        <Grid.Row columns={ 2 }>
                            ...
                            <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 16 }>
                                ...
                                <Hint>
                                    ...
                                    >
                                        Asgardeo supports receiving an OIDC authentication request as
                                        ...
                                        (
                                            <>
                                                <Field
                                                    ...
                                                    type="textarea"
                                                    validation={ (value: string, validation: Validation) => {
                                                        if (!CertificateManagementUtils.decodeCertificate(value)) {
                                                            validation.isValid = false;
                                                            validation.errorMessages.push(
                                                                t(

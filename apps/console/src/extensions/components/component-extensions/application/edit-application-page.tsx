...
import { AttributeSettings } from "./user-attribute-settings";
...
import { AppState, CORSOriginsListInterface, FeatureConfigInterface, getCORSOrigins } from "../../../../features/core";
...
export const EditApplication: FunctionComponent<EditApplicationPropsInterface> = (
    ...
    //TODO: Revise and re-enable after backend support is provided.

    ...
    const generateConfigureStep = (): ReactNode => {
        return (
            <>
                <Text>
                    <Trans
                        i18nKey={ "extensions:develop.identityProviders.github.quickStart.connectApp.description" }
                    >
                        Add <strong>GitHub</strong> authenticator to <strong>Step 1</strong> on
                        the <strong>Sign-in Method</strong> section of your
                        <LinkButton

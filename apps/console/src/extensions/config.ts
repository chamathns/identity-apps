    ...
    routes: {
        ...
        manage: [
            ...
            },
            {
                ...
                children: [
                    {
                        component: "./components/claims/pages/local-claims-edit",
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                    ...
                    {
                        component: "./components/claims/pages/local-claims",
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                    ...
                    {
                        component: "./components/claims/pages/external-dialect-edit",
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                    ...
                    {
                        component: "./components/claims/pages/attribute-mappings",
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                ...
                component: "./components/claims/pages/claim-dialects",
                exact: true,
                icon: {

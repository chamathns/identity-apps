                    ...
                    inboundOIDC: {
                        fields: {
                            ...
                            callBackUrls: {
                                ...
                                infoTraditional: "Try out a sample app using {{sampleCallbackURL}} as the" +
                                    " authorized redirect URL. You can download and run a sample at a later step." +
                                    " You may change the tomcat hostname and port of the URL to match your environment."
                            },
                            clientID: {
                                label: "Client ID"
                            },
